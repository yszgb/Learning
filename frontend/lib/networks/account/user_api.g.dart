...
class _RemoteUserApi implements RemoteUserApi {
  ...
  Future<UserBriefResponse> login(
    ...
    final _data = {'account': account, 'code': code};
    final _options = _setStreamType<UserBriefResponse>(
    ...
    late UserBriefResponse _value;
    try {
      _value = UserBriefResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<UserBriefResponse> getUserBrief() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
